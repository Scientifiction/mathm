class I{
    ...
    // divide1(n){
    //     return new I((this.real*n.real+this.imaginary*n.imaginary)/(n.real*n.real+n.imaginary*n.imaginary),(this.real*n.real-this.imaginary*n.imaginary)/(n.real*n.real+n.imaginary*n.imaginary))
    // }
}
module.exports=I;